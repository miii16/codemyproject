...
<body class="w-screen h-screen bg-white dark:bg-gray-900">    
    <nav class="bg-gray-800">
     ...
     <div class="container flex items-center gap-3 py-4">
        ...
        <p class="font-medium otext-black dark:text-white">Shop</p>
     </div>
     <!--side bar-->
     <div class="hidden w-screen h-screen col-span-1 px-4 pb-6 overflow-hidden bg-white rounded md:block dark:bg-gray-900">
        <div class="space-y-5 divide-y divide-gray-200">
            ...
            <div class="space-y-2">
                ...
                <div class="flex items-center">
                    <a href="paketan.html" name="cat-1" id="cat-1" class="ml-3 text-black cursor-pointer dark:text-white ">
                        Paketan</a>
                </div>
                <div class="flex items-center">
                ...
                <div class="flex items-center">
                    <a href="frozen.html" name="cat-1" id="cat-1" class="ml-3 text-gray-600 cursor-pointer text-primary">
                        Frozen</a>
                </div>
                <!--Products-->
     ...
     <div class="grid grid-cols-2 gap-6 md:grid-cols-3">
        <div class="overflow-hidden bg-white rounded shadow group">
            <div class="relative">
                <img src="{{ asset('images/frozen1.jpg') }}" alt="product 1" class="w-full">
            ...
            <div class="px-4 pt-4 pb-3">
                ...
                <div class="flex items-baseline mb-1 space-x-2">
                    <p class="text-xl font-semibold text-primary">198k</p>
                    <p class="text-sm text-gray-400 line-through">228k</p>
                </div>
                <div class="flex items-center">
        ...
        <div class="overflow-hidden bg-white rounded shadow group">
            <div class="relative">
                <img src="{{ asset('images/cumi.jpg') }}" alt="product 1" class="w-full">
                <div class="absolute inset-0 flex items-center justify-center gap-2 transition bg-black opacity-0 bg-opacity-40 group-hover:opacity-100">
                    <a href="#"
                        class="flex items-center justify-center h-8 text-lg text-white transition rounded-full w-9 bg-primary hover:bg-gray-800"
                        title="view product">
            ...
            <div class="px-4 pt-4 pb-3">
                ...
                <div class="flex items-baseline mb-1 space-x-2">
                    <p class="text-xl font-semibold text-primary">55k</p>
                    <p class="text-sm text-gray-400 line-through">80k</p>
                </div>
                <div class="flex items-center">
                    <div class="flex gap-1 text-sm text-yellow-400">
                        <span><i class="fa-solid fa-star"></i></span>
            ...
            <a href="#"
                ...
                <div class="overflow-hidden bg-white rounded shadow group">
                    <div class="relative">
                        <img src="{{ asset('images/cakalang.jpg') }}" alt="product 1" class="w-full">
                        <div class="absolute inset-0 flex items-center justify-center gap-2 transition bg-black opacity-0 bg-opacity-40 group-hover:opacity-100">
                            <a href="#"
                                class="flex items-center justify-center h-8 text-lg text-white transition rounded-full w-9 bg-primary hover:bg-gray-800"
                                title="view product">
                    ...
                    <div class="px-4 pt-4 pb-3">
                        ...
                        <div class="flex items-baseline mb-1 space-x-2">
                            <p class="text-xl font-semibold text-primary">60k</p>
                            <p class="text-sm text-gray-400 line-through">95</p>
                        </div>
                        <div class="flex items-center">
                            <div class="flex gap-1 text-sm text-yellow-400">
                                <span><i class="fa-solid fa-star"></i></span>
                    ...
                    <a href="#"
                        ...
                        <div class="overflow-hidden bg-white rounded shadow group">
                            <div class="relative">
                                <img src="{{ asset('images/dendenglambok.jpg') }}" alt="product 1" class="w-full">
                                <div class="absolute inset-0 flex items-center justify-center gap-2 transition bg-black opacity-0 bg-opacity-40 group-hover:opacity-100">
                                    <a href="#"
                                        class="flex items-center justify-center h-8 text-lg text-white transition rounded-full w-9 bg-primary hover:bg-gray-800"
                                        title="view product">
                            ...
                            <a href="#"
                                ...
                                <div class="overflow-hidden bg-white rounded shadow group">
                                    <div class="relative">
                                        <img src="{{ asset('images/iga.jpg') }}" alt="product 1" class="w-full">
                                        <div class="absolute inset-0 flex items-center justify-center gap-2 transition bg-black opacity-0 bg-opacity-40 group-hover:opacity-100">
                                            <a href="#"
                                                class="flex items-center justify-center h-8 text-lg text-white transition rounded-full w-9 bg-primary hover:bg-gray-800"
                                                title="view product">
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="overflow-hidden bg-white rounded shadow group">
                                            <div class="relative">
                                                <img src="{{ asset('images/paru.jpg') }}" alt="product 1" class="w-full">
                                                <div class="absolute inset-0 flex items-center justify-center gap-2 transition bg-black opacity-0 bg-opacity-40 group-hover:opacity-100">
                                                    <a href="#"
                                                        class="flex items-center justify-center h-8 text-lg text-white transition rounded-full w-9 bg-primary hover:bg-gray-800"
                                                        title="view product">
                                            ...
                                            <a href="#"
                                                ...
                                                <footer class="w-screen h-screen pt-16 pb-12 text-black border-t dark:text-white">
                                                    ...
                                                    <div class="grid grid-cols-2 col-span-2 gap-4">
                                                        <div class="grid grid-cols-2 gap-4 md:gap-8">
                                                            <div>
                                                                <h3 class="text-sm font-semibold tracking-wide text-black uppercase dark:text-white">Solutions</h3>
