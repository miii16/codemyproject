    ...
    <nav class="bg-gray-800">
        ...
        <div class="space-y-5 divide-y divide-gray-200">
            ...
            <div class="space-y-2">
                <div class="flex items-cennter">
                    <a href="shop.html" name="cat-1" id="cat-1" class="ml-3 text-gray-600 rounded-sm cursor-pointer focus:ring-0 text-primary">
                   Promo </a>
                </div>
     ...
     <div class="grid grid-cols-2 gap-6 md:grid-cols-3">
        <div class="overflow-hidden bg-white rounded shadow group">
            <div class="relative">
                <img src="{{ asset('images/promo1.jpg') }}" alt="product 1" class="w-full">
