    ...
    <nav class="bg-gray-800">
     ...
     <div class="hidden w-screen h-screen col-span-1 px-4 pb-6 overflow-hidden bg-white rounded md:block dark:bg-gray-900">
        <div class="space-y-5 divide-y divide-gray-200">
            ...
            <div class="space-y-2">
                ...
                <div class="flex items-center">
                    <a href="drink.html" name="cat-1" id="cat-1" class="ml-3 text-gray-600 cursor-pointer text-primary">
                        Drink</a>
                </div>
                <div class="flex items-center">
     ...
     <div class="grid grid-cols-2 gap-6 md:grid-cols-3">
        <div class="overflow-hidden bg-white rounded shadow group">
            <div class="relative">
                <img src="{{ asset('images/dadiah.jpg') }}" alt="product 1" class="w-full">
        ...
        <div class="overflow-hidden bg-white rounded shadow group">
            <div class="relative">
                <img src="{{ asset('images/daun.jpg') }}" alt="product 1" class="w-full">
                <div class="absolute inset-0 flex items-center justify-center gap-2 transition bg-black opacity-0 bg-opacity-40 group-hover:opacity-100">
                    <a href="#"
                        class="flex items-center justify-center h-8 text-lg text-white transition rounded-full w-9 bg-primary hover:bg-gray-800"
                        title="view product">
            ...
            <a href="#"
                ...
                <div class="overflow-hidden bg-white rounded shadow group">
                    <div class="relative">
                        <img src="{{ asset('images/tebak.jpg') }}" alt="product 1" class="w-full">
                        <div class="absolute inset-0 flex items-center justify-center gap-2 transition bg-black opacity-0 bg-opacity-40 group-hover:opacity-100">
                            <a href="#"
                                class="flex items-center justify-center h-8 text-lg text-white transition rounded-full w-9 bg-primary hover:bg-gray-800"
                                title="view product">
                    ...
                    <div class="px-4 pt-4 pb-3">
                        ...
                        <div class="flex items-baseline mb-1 space-x-2">
                            <p class="text-xl font-semibold text-primary">10k</p>
                    ...
                    <a href="#"
                        ...
                        <div class="overflow-hidden bg-white rounded shadow group">
                            <div class="relative">
                                <img src="{{ asset('images/papaya.jpg') }}" alt="product 1" class="w-full">
                                <div class="absolute inset-0 flex items-center justify-center gap-2 transition bg-black opacity-0 bg-opacity-40 group-hover:opacity-100">
                                    <a href="#"
                                        class="flex items-center justify-center h-8 text-lg text-white transition rounded-full w-9 bg-primary hover:bg-gray-800"
                                        title="view product">
                            ...
                            <a href="#"
                                ...
                                <div class="overflow-hidden bg-white rounded shadow group">
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="overflow-hidden bg-white rounded shadow group">
                                            <div class="relative">
                                                <img src="{{ asset('images/drink.jpg') }}" alt="product 1" class="w-full">
                                                <div class="absolute inset-0 flex items-center justify-center gap-2 transition bg-black opacity-0 bg-opacity-40 group-hover:opacity-100">
                                                    <a href="#"
                                                        class="flex items-center justify-center h-8 text-lg text-white transition rounded-full w-9 bg-primary hover:bg-gray-800"
                                                        title="view product">
