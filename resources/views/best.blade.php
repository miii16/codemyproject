...
<body class="w-screen h-screen bg-white dark:bg-gray-900">
    <nav class="bg-gray-800">
     ...
     <!--side bar-->
     <div class="hidden w-screen h-screen col-span-1 px-4 pb-6 overflow-hidden bg-white rounded md:block dark:bg-gray-900 dark:text-gray-500">
        <div class="space-y-5 divide-y divide-gray-200">
            ...
            <div class="space-y-2">
                ...
                <div class="flex items-center">
                    <a href="bestseller.html" name="cat-1" id="cat-1" class="ml-3 text-gray-600 rounded-sm cursor-pointer focus:ring-0 text-primary">
                        Best seller</a>
                </div>
                <div class="flex items-center">
